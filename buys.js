...
buys = [ 
		 {  
			...
			"<ul>"+
			"<li>It’s strategically located 1 minute off the Lekki Epe Expressway</li>"+
			"<li>it’s beside the popular <em>JIU HUA GROUP</em> Eleko</li>"+
			"<li>Directly facing the Eleko road before Amen Estate</li>"+
			"<li>It’s a ready to build estate</li>"+
			...
			"<b>Title: Governor’s Consent </b><br"+
			"<b>Price</b>"+
			"<ul>"+
		  ...
		  },
		  {
		    ...
		    "After the traffic and hustle that comes with living in the heart of Lagos, it’s ideal to return to a home & community that offers security, peace, serenity, facilities and ambiance comparable to living standards in developed countries.<br>"+
		    ...
		    "From the estate design and building / development control regulations, it’s clear that Genesis Court is designed to be a well organized, safe and serene neighbourhood within the heart of Lagos; that offers middle and upper class Lagosians an opportunity to reside among like minded people. </li>"+
		    ...
		    "<li>Estate Recreation Park (Sit out) & Children’s Playground</li>"+
		    ...
		    "<br><em>Outright Payment : ₦30,000/Sqm</em><br>"+
		    "<em>NGN12,000,000  for 400sqm</em>"+
		    "<br><em>Development Fee: ₦5,000 / Sqm</em>"+
		    "<br><em>Survey Fee: ₦1,000,000</em>"+
		    "<br><em>Legal / Documentation Fee: ₦400,000</em>"+
		    "<br><b>Any plot size can be purchased based on the budget and buyer’s preference</b>"+
		    "<br><b>3 Months Installment</b>"+
		    "<br><em>₦30,750/Sqm</em>"+
		    "<br><em>NGN12,300,000 for 400sqm</em>"+
		    "<br><em>Development Fee: ₦5,000 / Sqm</em>"+
		    "<br><em>Survey Fee: ₦1,000,000</em>"+
		    "<br><em>Legal / Documentation Fee: ₦400,000</em><br>"+
		    "<br><b>6 Months Installment</b>"+
		    "<br><em>₦31,500/Sqm</em>"+
		    "<br><em>NGN12,600,000 for 400sqm</em>"+
		    "<br><emDevelopment Fee: ₦5,000 / Sqm</em>"+
		    "<em>Survey Fee: ₦1,000,000</em>"+
		    "<br><em>Legal / Documentation Fee: ₦400,000</em>"+
		  ...
		  },
		  {
		    ...
		    "<em>Title</em>: Governor’s Consent"+
		    ...
		    "<b>Prices</b>:<br>"+
		    "👉  🏽2 Bedroom Terrace - N35m<br>"+
		    "👉  🏽3 Bedroom Terrace - N38m <br>"+
		    "👉  🏽3 Bedroom Semi-Detached - N43m<br>"+
		    "👉  🏽4 Bedroom Semi-Detached - N55m<br>"+
		    "<b>Neighbourhood:</b>"+
		    "<ul>"+
		 ...
		 { 
		    ...
		    "Isn’t that a great deal for you?😂</b>"+
